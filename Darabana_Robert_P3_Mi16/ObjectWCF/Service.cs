...
namespace ObjectWCF
{
    public class Service : InterfaceService
    {
        ...
        List<DynamicPropriety> InterfaceDynamicPropService.returnDynamicProps(string fullPath)
        {
            DynamicPropService service = new DynamicPropService();
            return service.returnDynamicProps(fullPath);

        }

        List<DynamicPropriety> InterfaceDynamicPropService.allDynamicProps()
        {
            DynamicPropService service = new DynamicPropService();
            return service.allDynamicProps();
        }
    }
}
