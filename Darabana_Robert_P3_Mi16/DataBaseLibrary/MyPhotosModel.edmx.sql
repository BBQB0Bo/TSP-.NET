...
-- --------------------------------------------------
-- Date Created: 04/14/2020 14:30:30
...
IF OBJECT_ID(N'[dbo].[FK_FilePropriety]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Proprieties] DROP CONSTRAINT [FK_FilePropriety];
GO
IF OBJECT_ID(N'[dbo].[FK_FileDynamicPropriety_File]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FileDynamicPropriety] DROP CONSTRAINT [FK_FileDynamicPropriety_File];
GO
IF OBJECT_ID(N'[dbo].[FK_FileDynamicPropriety_DynamicPropriety]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FileDynamicPropriety] DROP CONSTRAINT [FK_FileDynamicPropriety_DynamicPropriety];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Proprieties]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Proprieties];
GO
IF OBJECT_ID(N'[dbo].[DynamicProprieties]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DynamicProprieties];
GO
IF OBJECT_ID(N'[dbo].[FileDynamicPropriety]', 'U') IS NOT NULL
    DROP TABLE [dbo].[FileDynamicPropriety];
GO
