...
public interface IPostComment
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/InterfacePost/AddPost", ReplyAction = "http://tempuri.org/InterfacePost/AddPostResponse")]
    System.Threading.Tasks.Task<bool> AddPostAsync();
    ...
    bool AddComment(PostComment.Comment c);

    [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/InterfaceComment/AddComment", ReplyAction = "http://tempuri.org/InterfaceComment/AddCommentResponse")]
    System.Threading.Tasks.Task<bool> AddCommentAsync(PostComment.Comment c);
...
public partial class PostCommentClient : System.ServiceModel.ClientBase<IPostComment>, IPostComment
{
    ...
    public bool AddPost()
    {
        return base.Channel.AddPost();
    }

    public System.Threading.Tasks.Task<bool> AddPostAsync()
    {
        return base.Channel.AddPostAsync();
    }
    ...
    public bool AddComment(PostComment.Comment c)
    {
        return base.Channel.AddComment(c);
    }

    public System.Threading.Tasks.Task<bool> AddCommentAsync(PostComment.Comment c)
    {
        return base.Channel.AddCommentAsync(c);
    }
